...
public class ExampleBibTex {
	...
	public String runGrobid(String pdfPath, String process) {
		...
		try {
			...
			prop.load(new FileInputStream("/mnt/Titas/1_QA_MODEL/Tools/Grobid/grobid-example/grobid-example.properties"));
			String pGrobidHome = prop.getProperty("/mnt/Titas/1_QA_MODEL/Tools/Grobid/grobid-example/grobid_example.pGrobidHome");
			String pGrobidProperties = prop.getProperty("/mnt/Titas/1_QA_MODEL/Tools/Grobid/grobid-example/grobid_example.pGrobidProperties");
